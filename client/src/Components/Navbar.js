...
function Navbar(props) {
    return (
        <nav className="navbar navbar-expand-lg navbar-dark justify-content-center text-center rounded-bottom"   style={{position:"sticky" ,top:"0",zIndex:"1",backgroundColor:"#1C9BF1"}}>
